      ...
      <CardContent>
        {isLoading ? (
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <Badge variant="outline" className="text-xs border-gray-600">
                      {isStock ? t('dashboard.recentAnalyses.stock') : analysis.trading_type?.toUpperCase()}
                    </Badge>
                  </div>
                  ...
                  <div className="flex items-center gap-4 text-xs text-gray-500">
                    ...
                    <span className="flex items-center gap-1">
                      ...
                      {analysis.confidence_score}% {t('dashboard.recentAnalyses.accuracy')}
                    </span>
                  </div>
                </div>
          ...
          <div className="text-center py-8">
            ...
            <p className="text-gray-400">{t('dashboard.recentAnalyses.noAnalysis')}</p>
            <p className="text-sm text-gray-500 mt-1">
              {t('dashboard.recentAnalyses.uploadFirst')}
            </p>
          </div>
        )}
      </CardContent>
